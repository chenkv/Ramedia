...
export default function MoviesHome() {
  ...
  const { data, error } = useSWR('/api/trending-games', fetcher)
  ...
  function showSlides(n) {
    ...
    if (data) {
      document.getElementById('title').innerHTML = data.trending.results[slideIndex - 1].name;
      document.getElementById('description').innerHTML = data.trending.results[slideIndex - 1].description.description_raw;
      document.getElementById('year').innerHTML = data.trending.results[slideIndex - 1].released.toString().slice(0, 4);
      document.getElementById('rating').innerHTML = data.trending.results[slideIndex - 1].esrb_rating.name;
      document.getElementById('playtime').innerHTML = data.trending.results[slideIndex - 1].description.playtime + "h";
    ...
    //   }      
      ...
      document.getElementById('vote').innerHTML = data.trending.results[slideIndex - 1].metacritic + "/100";
      document.getElementById('vote2').innerHTML = data.trending.results[slideIndex - 1].metacritic + "/100";
    }
  }
      ...
      <div>
        ...
        <main className='scroll-smooth'>
          <div className='flex justify-center lg:py-12 md:py-8 py-6'>
            <h1 className='2xl:text-6xl md:text-5xl sm:text-4xl text-3xl font-bold tracking-wider'>Games</h1>
          </div>

          <div className='lg:flex-row flex-col flex'>
            <div className='xl:w-3/4 lg:w-[70%] flex-none relative z-10'>
              {
                data.trending.results.map((element) => {
                  ...
                  return (
                    <div key={element.name} id={data.trending.results.indexOf(element)} className={`${styles.mySlides} ${styles.fade}`}>
                      <h3 className='w-[70%] h-full'>{element.name}</h3>
                    </div>
                  )
                })
              }
            ...
            <div className='lg:h-[56vh] flex flex-col z-10 overflow-hidden'>
          ...
          {/* <div className='xl:-translate-y-32 xl:pt-44 lg:-translate-y-20 lg:pt-28 pt-6 rounded-xl bg-[#FFE3CE]'>
            <h2 className='text-4xl font-semibold ml-10'>Trending Games</h2>
          ...
          <div className='-translate-y-32'>
            <h2 className='text-4xl font-semibold ml-10'>Anticipated Games</h2>
            <div className='relative justify-center items-center'>
