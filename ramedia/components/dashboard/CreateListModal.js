export default function CreateListModal({ enabled, modalHandler, user }) {
  if (!enabled) return;
    ...
    <div id="modal"
      ...
      <div className="relative px-6 pb-4 bg-[#F9F6F7] rounded-3xl overflow-auto" onClick={e => e.stopPropagation()}>
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <form className="h-min w-min" onSubmit={createList}>
            <label htmlFor='listname'>Name of list:</label><br />
            <input type='text' id='listname' required/> <br />
            <label htmlFor='listdescription'>Description:</label><br />
            <input type='text' id='listdescription' /><br />
            <input type='submit' value='Sus' className=""/>
          </form>
        </div>
      </div>
    </div>
